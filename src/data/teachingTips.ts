...
export const teachingTips: Record<number, Record<string, TeachingTip>> = {
  ...
  0: {
    ...
    '4': {
      ...
      keyPoints: [
        ...
        'Operator // menghasilkan pembagian bulat, sedangkan / selalu menghasilkan float.',
      ...
      teachingNotes:
        'Ajak siswa menghitung secara manual terlebih dahulu, lalu bandingkan dengan hasil Python. Ini membantu memahami urutan prioritas operator.',
    },
  },
  ...
  2: {
    ...
    'list-tricks': {
      objectives: [
        'Mengenal teknik-teknik praktis dalam penggunaan list.',
        'Mampu melakukan unpacking dan swapping dengan list.',
        'Memahami penggunaan enumerate() dan list sebagai stack/queue.',
      ],
      keyPoints: [
        'Unpacking: a, b, c = [1, 2, 3] untuk assign beberapa variabel sekaligus.',
        'Swapping: a, b = b, a tanpa variabel sementara.',
        'enumerate() memberikan indeks dan nilai saat iterasi.',
        'List bisa digunakan sebagai stack (LIFO) dengan append() dan pop().',
        'Untuk queue (FIFO), gunakan collections.deque agar lebih efisien.',
      ],
      commonMistakes: [
        'Jumlah variabel unpacking tidak sesuai dengan jumlah elemen list.',
        'Menggunakan list sebagai queue dengan pop(0) yang tidak efisien untuk data besar.',
      ],
      discussionQuestions: [
        'Dalam situasi apa enumerate() lebih berguna dari range(len())?',
        'Mengapa list tidak ideal sebagai queue untuk data dalam jumlah besar?',
      ],
      teachingNotes:
        'Tunjukkan trik-trik ini sebagai cara pythonic dalam menulis kode. Bandingkan dengan cara konvensional agar siswa menghargai keeleganan Python.',
    },
  },
  ...
  5: {
    lesson1: {
      objectives: [
        ...
        'Mampu membuat class dan instance di Python.',
        'Menguasai penggunaan __init__, self, dan method.',
        'Mengenal konsep inheritance (pewarisan).',
      ],
      keyPoints: [
        'Class adalah blueprint untuk membuat object dengan atribut dan method.',
        '__init__() adalah constructor yang dipanggil saat membuat instance baru.',
        'self merujuk pada instance saat ini dan harus menjadi parameter pertama setiap method.',
        'Inheritance memungkinkan class baru mewarisi atribut dan method dari class induk.',
        'Encapsulation menyembunyikan detail implementasi dari pengguna class.',
      ],
      commonMistakes: [
        'Lupa menuliskan self sebagai parameter pertama pada method.',
        'Mengira class dan instance adalah hal yang sama.',
        'Tidak memanggil super().__init__() saat membuat class turunan.',
      ],
      discussionQuestions: [
        'Apa keuntungan menggunakan OOP dibanding pendekatan prosedural?',
        'Berikan contoh object di dunia nyata dan atribut serta method-nya.',
        'Kapan inheritance tepat digunakan dan kapan komposisi lebih baik?',
      ],
      teachingNotes:
        'Gunakan analogi cetakan kue (class) dan kue yang dihasilkan (instance). Mulai dengan class sederhana sebelum memperkenalkan inheritance.',
    },
    lesson2: {
      objectives: [
